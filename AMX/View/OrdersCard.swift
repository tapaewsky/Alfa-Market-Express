...
struct OrdersCard: View {
    ...
    private var statusBackgroundColor: Color {
        ...
        case "получен": return Color.green
        case "отказано": return Color.red
        case "обработка": return Color.orange
        case "доставка": return Color.blue
        case "сборка": return Color.yellow
        case "отменен": return Color.gray
